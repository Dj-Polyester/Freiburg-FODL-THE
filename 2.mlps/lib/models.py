...
def create_2unit_net() -> Sequential:
    ...
    # weight 1
    model.modules[0].W.data = np.array(
        [
            [3.21, -2.34],
            [3.21, -2.34],
        ]
    ...
    # bias 1
    model.modules[0].b.data = np.array([-3.21, 2.34])
    # weight 2
    model.modules[2].W.data = np.array(
        [
            [3.19, -2.68],
            [4.64, -3.44],
        ]
    ...
    # bias 2
    model.modules[2].b.data = np.array([-4.08, 4.42])
    # END TODO ##################
...
def create_3unit_net() -> Sequential:
    ...
    # bias 1
    model.modules[0].b.data = np.array([-3.21, 2.34, -3.16])
    # weight 2
    model.modules[2].W.data = np.array(
        [
            [0.03, -5.84],
