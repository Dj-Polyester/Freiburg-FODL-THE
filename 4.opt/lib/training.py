...
def create_and_train_model(
    ...
    optim = create_optimizer(opt_name, model.parameters(), opt_hyperparams)
...
def compare_optimizers() -> (
    ...
    optim_results = {
        "sgd": create_and_train_model("sgd", {"lr": sgd_learning_rate}, *args),
        "sgd_momentum": create_and_train_model(
            "sgd", {"lr": sgd_learning_rate, "momentum": momentum}, *args
        ),
        "adam": create_and_train_model("ADAM", {"lr": adam_learning_rate}, *args),
    }
    # END TODO ###################
